...
import { DocumentSpinner } from "~/components/editor/primitives/Spinner";
...
export function Editor() {
  // const liveblocks = useLiveblocksExtension(); // O11
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.editorPanel}>
        ...
        {/* O11 <FloatingComposer editor={editor} style={{ width: 350 }} /> */}
        {/* O11 <FloatingThreads threads={threads} editor={editor} /> */}
      </div>
    </div>
  );
}
